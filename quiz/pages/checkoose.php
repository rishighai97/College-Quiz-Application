...
$sql="select oose from quiz where roll=".$_SESSION["roll"];
$result=mysqli_query($conn,$sql);
$result_value = mysqli_fetch_object($result);
if($result_value->oose!="not attempted"){
    header("Location: http://localhost/quiz/pages/quiz.php");
    exit();
}

$sql = "SELECT * FROM oose ";
$result = mysqli_query($conn, $sql);
session_start();
...
$_SESSION["paper"]="oose";
$_SESSION["title"]="Object Oriented Software Engineering";
?>